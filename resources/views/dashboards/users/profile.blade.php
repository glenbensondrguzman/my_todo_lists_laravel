            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <h3 class="profile-username text-center admin_name">{{Auth::user()->firstname}}</h3>
                    ...
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('userUpdateInfo') }}" id="UserInfoForm">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName" placeholder="Name" value="{{ Auth::user()->firstname }}" name="firstname">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputName" placeholder="Name" value="{{ Auth::user()->lastname }}" name="lastname">
                              <span class="text-danger error-text name_error"></span>
                            </div>
                          </div>
